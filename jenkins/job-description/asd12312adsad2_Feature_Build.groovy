...
def job_config = [
    job: [
        name: "asd12312adsad2_Feature_Build",
        agent: "maven"
    ]
]
def config = [
...
def customLib = library identifier: 'asd12312adsad2_JSL@develop', retriever: modernSCM(
  [\$class: 'GitSCMSource',
   remote: 'https://github.developer.allianz.io/kkanto/asd12312adsad2_lib.git',
   credentialsId: 'git-token-credentials']) 
...
def jslCustom     = customLib.de.allianz.Asd12312adsad2.new()
    ...
    stage('Prepare') {
      steps {
        ...
        script {
          ...
          jslGit.checkout( config, "kkanto", "asd12312adsad2", branch_name)
          }
        }
      }
stage('Build') {
...
"""
def job = pipelineJob("asd12312adsad2_Feature_Build");
...
job.with {
    ...
    authenticationToken('Kt0GudWW6GEqAkQ4cHnLwTxPXnMjPxhY')
